...
ROLE_FILE: ~/.claude/.ccx/prompts/codex/debugger.md
<TASK>
需求：<增强后的需求>
上下文：<错误日志、堆栈信息、复现步骤>
</TASK>
...
ROLE_FILE: ~/.claude/.ccx/prompts/gemini/debugger.md
<TASK>
需求：<增强后的需求>
上下文：<错误日志、堆栈信息、复现步骤>
</TASK>
...
| 模型 | 提示词 |
|------|--------|
| Codex | `~/.claude/.ccx/prompts/codex/debugger.md` |
| Gemini | `~/.claude/.ccx/prompts/gemini/debugger.md` |
