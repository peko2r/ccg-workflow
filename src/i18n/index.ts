...
const zhCN = {
  ...
  cli: {
    help: {
      ...
      commandDescriptions: {
        showMenu: '显示交互式菜单（默认）',
        initConfig: '初始化 Claude Code Ex 多模型协作系统',
        update: '更新工作流到最新版本',
        uninstall: '彻底卸载 CCX 受管文件与配置',
        configMcp: '配置 MCP Token',
        diagnoseMcp: '诊断 MCP 配置问题',
        fixMcp: '修复 Windows MCP 配置',
        bridgeLaunch: '启动 bridge provider 面板',
        bridgeAsk: '提交 provider 异步请求（占位实现）',
        bridgePing: '检查 provider bridge 状态',
        bridgePend: '查看 provider 待处理请求（占位实现）',
        bridgeMounted: '查看已挂载 provider',
        bridgeCleanup: '清理 bridge 运行态（当前为 dry-run）',
        maild: '管理 CCX Mail 邮箱守护进程',
      },
      shortcuts: '快捷方式:',
      ...
      optionDescriptions: {
        ...
        workflows: '要安装的工作流',
        installDir: '安装目录',
        bridgeRestore: '恢复 bridge 会话元数据（预留）',
        bridgeAutoApprove: '启用 bridge 自动授权模式（预留）',
      },
      ...
      exampleDescriptions: {
        ...
        fullUninstall: '彻底卸载 CCX',
        customModels: '自定义模型配置',
        parallelMode: '使用并行协作模式',
        bridgeLaunch: '启动 bridge provider',
        bridgeAsk: '提交 bridge 请求并查看挂载状态',
      },
    },
  },
  init: {
    welcome: '欢迎使用 Claude Code Ex 多模型协作系统',
    subtitle: '多模型协作开发工作流',
    ...
    mcp: {
      ...
      aceToolRsPaid: '更轻量',
      skipLater: '稍后手动配置',
      skipTokenPrompt: '是否跳过 Token 配置？（可稍后运行 npx ccx config mcp 配置）',
      skipKeyPrompt: '是否跳过 API Key 配置？（可稍后运行 npx ccx config mcp 配置）',
    ...
    bridge: {
      title: 'Bridge',
      shimsInstalled: '已安装语义命令: {{shims}}',
      powershellReady: 'PowerShell 语义入口复用主 ccx bridge 实现',
      ...
      weztermInstallHint: '安装 WezTerm 后可使用 ccx codex gemini 或 ccx bridge codex',
    },
    ...
    workflows: {
      dev: '完整开发工作流 (/ccx:dev)',
      frontend: '前端任务 (/ccx:frontend)',
      backend: '后端任务 (/ccx:backend)',
      review: '代码审查 (/ccx:review)',
      analyze: '技术分析 (/ccx:analyze)',
      commit: 'Git 智能提交 (/ccx:commit)',
      rollback: 'Git 回滚 (/ccx:rollback)',
      cleanBranches: '清理分支 (/ccx:clean-branches)',
      worktree: 'Worktree 管理 (/ccx:worktree)',
      init: '项目初始化 (/ccx:init)',
    },
    aceTool: {
  ...
  menu: {
    ...
    uninstall: {
      globalDetected: '检测到你是通过 npm 全局安装的',
      confirm: '确定要彻底卸载 CCX 吗？这将移除所有由 CCX 明确管理的文件、MCP 镜像与自动授权配置。',
      uninstalling: '正在卸载...',
      success: 'CCX 受管文件与配置已移除',
      removedCommands: '已移除命令:',
      removedAgents: '已移除子智能体:',
      removedSkills: '已移除 Skills:',
      removedBridgeShims: '已移除 bridge shim:',
      removedRules: '已移除规则文件:',
      removedBin: '已移除二进制文件:',
      removedMcpServers: '已移除 Claude MCP:',
      removedCodexMirror: '已移除 Codex MCP 镜像:',
      removedGeminiMirror: '已移除 Gemini MCP 镜像:',
      removedSettingsEntries: '已移除 settings.json 条目:',
      removedOutputStyles: '已移除输出风格文件:',
      removedContextWeaver: '已移除 ContextWeaver 目录:',
      cancelled: '卸载已取消',
      failed: '卸载失败',
      lastStep: '最后一步：卸载 npm 全局包',
      runInNewTerminal: '请在新的终端窗口中运行：',
      afterDone: '完成后 ccx 命令将彻底移除',
    },
  },
}
...
const en: typeof zhCN = {
  ...
  cli: {
    help: {
      ...
      commandDescriptions: {
        ...
        update: 'Update workflows to the latest version',
        uninstall: 'Fully uninstall CCX managed files and config',
        configMcp: 'Configure MCP Token',
        diagnoseMcp: 'Diagnose MCP configuration issues',
        fixMcp: 'Fix Windows MCP configuration',
        bridgeLaunch: 'Launch bridge provider panes',
        bridgeAsk: 'Submit provider async request (placeholder)',
        bridgePing: 'Check provider bridge status',
        bridgePend: 'Inspect provider pending requests (placeholder)',
        bridgeMounted: 'Show mounted providers',
        bridgeCleanup: 'Clean bridge runtime (dry-run for now)',
        maild: 'Manage the CCX Mail daemon',
      },
      shortcuts: 'Shortcuts:',
      shortcutDescriptions: {
      ...
      optionDescriptions: {
        ...
        bridgeRestore: 'Reuse bridge session metadata (reserved)',
        bridgeAutoApprove: 'Enable bridge auto-approve mode (reserved)',
      },
      ...
      exampleDescriptions: {
        ...
        fullUninstall: 'Fully uninstall CCX',
        customModels: 'Custom model configuration',
        parallelMode: 'Use parallel collaboration mode',
        bridgeLaunch: 'Launch bridge providers',
        bridgeAsk: 'Submit a bridge request and inspect mounted status',
      },
    },
  },
  init: {
    ...
    mcp: {
      ...
      skipTokenPrompt: 'Skip Token configuration? (run npx ccx config mcp later)',
      skipKeyPrompt: 'Skip API Key configuration? (run npx ccx config mcp later)',
    ...
    bridge: {
      ...
      weztermInstallHint: 'Install WezTerm to use ccx codex gemini or ccx bridge codex,gemini',
    },
    ...
    workflows: {
      dev: 'Full development workflow (/ccx:dev)',
      frontend: 'Frontend tasks (/ccx:frontend)',
      backend: 'Backend tasks (/ccx:backend)',
      review: 'Code review (/ccx:review)',
      analyze: 'Technical analysis (/ccx:analyze)',
      commit: 'Git smart commit (/ccx:commit)',
      rollback: 'Git rollback (/ccx:rollback)',
      cleanBranches: 'Clean branches (/ccx:clean-branches)',
      worktree: 'Worktree management (/ccx:worktree)',
      init: 'Project initialization (/ccx:init)',
    },
    aceTool: {
  ...
  menu: {
    ...
    options: {
      ...
      uninstall: 'Uninstall CCX',
      help: 'Help',
      exit: 'Exit',
    },
    help: {
      title: 'CCG Commands:',
      hint: 'For more information, run: npx ccx --help',
      sections: {
    ...
    uninstall: {
      globalDetected: 'Detected npm global installation',
      confirm: 'Are you sure you want to fully uninstall CCX? This removes all CCX-managed files, MCP mirrors, and auto-approval settings.',
      uninstalling: 'Uninstalling...',
      success: 'CCX managed files and configuration removed',
      removedCommands: 'Removed commands:',
      removedAgents: 'Removed agents:',
      removedSkills: 'Removed skills:',
      removedBridgeShims: 'Removed bridge shims:',
      removedRules: 'Removed rule files:',
      removedBin: 'Removed binary:',
      removedMcpServers: 'Removed Claude MCP servers:',
      removedCodexMirror: 'Removed Codex MCP mirror:',
      removedGeminiMirror: 'Removed Gemini MCP mirror:',
      removedSettingsEntries: 'Removed settings.json entries:',
      removedOutputStyles: 'Removed output style files:',
      removedContextWeaver: 'Removed ContextWeaver directory:',
      cancelled: 'Uninstallation cancelled',
      failed: 'Uninstallation failed',
      lastStep: 'Last step: uninstall npm global package',
      runInNewTerminal: 'Please run in a new terminal window:',
      afterDone: 'After completion, the ccx command will be fully removed',
    },
  },
}
